...
'''`.trim(),
  ...
  await prisma.prompt.create({
    data: {
      ...
      template: `Seu papel é exibir a transcrição completa do vídeo.

Abaixo você receberá uma transcrição desse vídeo, formate essa transcrição para que fique claro para o usuário o que está acontecendo.

O retorno deve seguir o seguinte formato:
'''
Tempo (se houver) - Personagem (se houver) - Fala
Tempo (se houver) - Personagem (se houver) - Fala
Tempo (se houver) - Personagem (se houver) - Fala
...
'''
